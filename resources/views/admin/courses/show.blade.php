...
<x-app-layout>
    <section class="container bg-gray-700 py-12 mb-12">
        <div class="container grid grid-cols-1 lg:grid-cols-2 gap-6">
            <figure>
                @if ($course->image)
                    <img class="object-cover h-72 w-full" src="{{Storage::url($course->image->url)}}" alt="">    
                @else
                    <img class="w-full h-full object-cover object-center"  src="https://cdn.pixabay.com/photo/2018/05/19/00/53/online-3412473_960_720.jpg" alt="">
                @endif
            </figure>
    ...
    <div class="container grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        @if (session('info'))
            <div class="lg:col-span-3" x-data="{open: true}" x-show="open">
                <div class="relative py-3 pl-4 pr-10 leading-normal text-red-700 bg-red-100 rounded-lg" role="">
        ...
        <div class="order-2 lg:col-span-2 lg:order-1">
            ...
            <section class="card mb-8">
                <div class="card-body">
                    ...
                    <ul class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-2">
                        ...
                        @empty
                            <li class="text-red-500 text-base">Este curso no tiene asignada ninguna meta</li>                            
                        @endforelse                                              
                    </ul>
                </div>
            </section>
            ...
            <section class="mb-8">
                ...
                @empty
                    <article class="card">
                        <div class="card-body">
                            <p class="text-red-500 text-base">Este curso no tiene ninguna seccion asignada</p>      
                        </div>
                    </article>
                @endforelse  
            </section>
            ...
            <section class="mb-8">
                ...
                <ul class="list-disc list-inside">
                    ...
                    <article class="card">
                        <div class="card-body">
                            <p class="text-red-500 text-base">Este curso no tiene ninguna requisito asignado</p>      
                        </div>
                    </article>
                    @endforelse
                </ul>
            ...
            <section class="card mb-4">
                <div class="card-body">
                    ...
                    <form action="{{route('admin.courses.approved', $course)}}" class="mt-4" method="POST">
                        @csrf
                        <button type="submit" class="btn btn-success btn-block mt-4">Aprobar curso</button>
                    </form>

                    <a href="{{route('admin.courses.observation', $course)}}" class="btn btn-danger btn-block mt-4">Observar curso</a>
