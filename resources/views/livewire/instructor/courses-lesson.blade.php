<div>
    @foreach ($section->lessons as $item)
        <article class="card mt-4" x-data="{open: false}">
            <div class="card-body">
                ...
                @else 
                    <header>
                        <h1 x-on:click="open = !open" class="cursor-pointer"><i class="far fa-play-circle text-green-500 mr-1"></i>Lección: {{$item->name}}</h1>
                    </header>                 
                    <div x-show="open">
                        <hr class="my-2">
                        ...
                        <div class="my-2">
                            <button class="btn btn-success text-sm" wire:click="edit({{$item}})">Editar</button>
    ...
    <div class="mt-4" x-data="{open: false}">
        ...
        <article class="card" x-show="open">
            <div class="card-body">
                <h1 class="text-xl font-bold mb-2">Agregar nueva lección</h1>
