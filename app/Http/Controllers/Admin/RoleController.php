...
class RoleController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->middleware('can:Elimiar rol')->only('destroy');
    ...
    public function update(Request $request, Role $role)
    {
        ...
        return redirect()->route('admin.roles.index', $role)->with('info', 'Se ha actualizado correctamente.');
    }
    ...
    public function destroy(Role $role)
    {
        ...
        return redirect()->route('admin.roles.index')->with('info', 'Se ha eliminado correctamente.');
    }
}
